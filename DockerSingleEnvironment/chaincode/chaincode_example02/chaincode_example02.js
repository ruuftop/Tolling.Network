...
===================== Add new Accounts ==============================
peer chaincode invoke -n mycc -C mychannel -c '{"Args":["addAccount","C032699024","TX","3PCH418","A8-5F-E6-05-C3-4D","SCHJ.575596372","1"]}'
peer chaincode invoke -n mycc -C mychannel -c '{"Args":["addAccount","A358036353","CA","1OXF345","F0-FD-A4-80-C3-43","BOMC.521511316","1"]}'
peer chaincode invoke -n mycc -C mychannel -c '{"Args":["addAccount","B541007088","MI","7DWL777","B7-4A-52-7C-8F-42","OLYT.406781605","1"]}'
peer chaincode invoke -n mycc -C mychannel -c '{"Args":["addAccount","D351370886","NY","7FAY856","E1-0F-98-FF-04-5F","AZBM.469240152","1"]}'


==================== Query Account data =================
peer chaincode query -C mychannel -n mycc -c '{"Args":["queryAccount", "A358036353"]}'

=================== Change Account Status ===================
peer chaincode invoke -C mychannel -n mycc -c '{"Args":["changeAccountStatus", "C032699024", "0"]}'

=================== Add new transactions ===================
peer chaincode invoke -C mychannel -n mycc -c '{"Args":["addTransaction", "C032699024", "A", "2" , "10/16/2018", "2", "locA1", "unpaid"]}'
peer chaincode invoke -C mychannel -n mycc -c '{"Args":["addTransaction", "A358036353", "B", "2" , "10/18/2018", "3", "locB1", "unpaid"]}'
peer chaincode invoke -C mychannel -n mycc -c '{"Args":["addTransaction", "B541007088", "D", "3" , "10/21/2018", "4", "locD1", "unpaid"]}'
peer chaincode invoke -C mychannel -n mycc -c '{"Args":["addTransaction", "D351370886", "C", "3" , "10/15/2018", "5", "locC1", "paid"]}'

==================== Query transaction data based on transaction id =================
peer chaincode query -C mychannel -n mycc -c '{"Args":["queryTransaction", "1"]}'

==================== Query transaction data based on Host =================
peer chaincode query -C mychannel -n mycc -c '{"Args":["queryTransactionsByHost", "D"]}'
