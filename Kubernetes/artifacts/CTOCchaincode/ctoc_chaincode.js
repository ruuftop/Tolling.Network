...
var Chaincode = class {
  ...
  async addTollCharges(stub, args){
    ...
    toll_charges = JSON.parse(toll_charges.toBuffer().toString());
  ...
  async addReconTollCharges(stub,args){
    ...
    recon_toll_charges = JSON.parse(recon_toll_charges.toBuffer().toString());
  ...
  async addPaybyPlate(stub,args) {
    ...
    pay_by_plate = JSON.parse(pay_by_plate.toBuffer().toString());
  ...
  async addReconPaybyPlate(stub,args) {
   console.info('============= END : adding  recon pay by plate recon record ===========');
    ...
    recon_pay_by_plate = JSON.parse(recon_pay_by_plate.toBuffer().toString());
  ...
  async addLicensePlateStatus(stub,args) {
    ...
    license_plate_status = JSON.parse(license_plate_status.toBuffer().toString());
